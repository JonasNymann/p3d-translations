{
	"masthead": {
		"slider": [{
				"headings": [
					"En blockchain styret,",
					"smart-contract økonomi",
					"i tre dimensioner"
				],
				"sub": "Den første token støttet direkte a Ethereum, som også er den mest populære Dapp. (Kilde: Dappradar.com)",
				"button": "Test your grip"
			},
			{
				"headings": [
					"Du får en del",
					"Af alle udvekslings gebyrer"
				],
				"sub": "Volume baseret indkomst, lidt ligesom UBI, men mindre af en joke."
			},
			{
				"headings": [
					"Min svage hænder",
			...
			{
				"headings": [
					"Spil med et 3D økosystem",
					"Nyd multidimensionelle gevinster"
				],
				"sub": "Kun normale tab til gengæld, vi arbejder på den."
			}
		]
	},
	"explanation": {
		"header": "Hvordan virker det?",
		"lead": "Hver handel, køb eller salg, har en 10% fast transaktions gebyr påført.",
		"hover": "Proof of Weak Hands",
		"bold": "Istedet for at det går til udvekslingen,<br> bliver gebyrn <i>delt mellem alle aktuelt holdte tokens!</i>",
		"more": "10% af alt volume this cryptocurrency ever experiences, is set aside for you the token holders, as ethereum rewards that you can instantly withdraw whenever you'd like.",
